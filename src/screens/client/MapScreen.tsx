...
import { Search, MapPin, Clock, Tag, Map, AlertCircle, ChevronRight } from 'lucide-react-native';
        ...
        <View style={styles.cardInfo}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoText}>
              Teslim: {offer.pickup_start} - {offer.pickup_end}
            </Text>
          </View>
        </View>
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTitleRow}>
          ...
          <Text style={styles.headerTitle}>Yakınımdaki Teklifler</Text>
        </View>
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtext}>
              Aramanızı değiştirmeyi veya filtrelerinizi kaldırmayı deneyin
            </Text>
          </View>
        }
      />
